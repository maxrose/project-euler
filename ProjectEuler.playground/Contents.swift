...
let problemMask: ProblemSelection = .problem10
...
if problemMask.contains(.problem10) {
    ...
    printTestCase(sumPrimesBelow(10))
    printResultCase(sumPrimesBelow(2000000))
}

// Problem 11
if problemMask.contains(.problem11) {
    print("\nProblem 11")
...
// Problem 12
if problemMask.contains(.problem12) {
    print("\nProblem 12")
...
// Problem 13
if problemMask.contains(.problem13) {
    print("\nProblem 13")
...
// Problem 14
if problemMask.contains(.problem14) {
    print("\nProblem 14")
...
// Problem 15
if problemMask.contains(.problem15) {
    print("\nProblem 15")
...
/*
// Problem <# n #>
if problemMask.contains(.problem<#n#>) {
    print("\nProblem <#n#>")
    print("<#description#>")
